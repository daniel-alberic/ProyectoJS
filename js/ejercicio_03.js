...
let nombreObrero = "Karles Pérez";
let cantidadPrendas = 120;

// FASE DE PROCESO: OPERACIONES Y CÁLCULOS
const tarifaPorPrendas = 10;
let sueldoBruto = cantidadPrendas * tarifaPorPrendas;
...
console.log("👷‍♂️ Obrero:", nombreObrero);
